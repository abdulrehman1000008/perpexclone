...
# 🚨 IMMEDIATE FIX for perpexclone deployment errors
# Run this script to fix your current deployment issues
...
# Your specific URLs
FRONTEND_URL="https://perpexclone-halehngwf.vercel.app"
BACKEND_URL="https://perpexclone.onrender.com"
...
echo "curl -s $BACKEND_URL/api/health | grep status"
echo ""
echo "Test 2 - Check CORS configuration:"
echo "curl -s -X OPTIONS -H \"Origin: $FRONTEND_URL\" $BACKEND_URL/api/auth/login -w \"%{http_code}\""
echo ""
echo "Test 3 - Check manifest file:"
echo "curl -s -w \"%{http_code}\" $FRONTEND_URL/manifest.json"
echo ""
